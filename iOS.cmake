...
set (CMAKE_CXX_FLAGS "-headerpad_max_install_names -fvisibility=hidden -fvisibility-inlines-hidden -x objective-c++")
...
message(STATUS "iOS Platform is : ${IOS_PLATFORM}")
message(STATUS "iOS SDK Root is : ${CMAKE_IOS_DEVELOPER_ROOT}")
...
set (CMAKE_OSX_ARCHITECTURES "x86_64" CACHE string  "Build architecture for iOS")
